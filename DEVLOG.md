...
Chose to use chooseUser() at the last moment; added functionality for that; cleaned up some more code; added a new file called "wins.c" to contain some excess functions that we used (related to handling winning); new make win to show all time leaderboards! ~30 minutes
```
